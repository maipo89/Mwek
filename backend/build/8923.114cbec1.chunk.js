...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)},n.exports.default=n.exports,n.exports.__esModule=!0},29:function(n,a,t){var i=t(42),r=t(43),p=t(22),c=t(44);n.exports=function(d){return i(d)||r(d)||p(d)||c()},n.exports.default=n.exports,n.exports.__esModule=!0},3:function(n,a){n.exports=function(t,i){return i||(i=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(i)}}))},n.exports.default=n.exports,n.exports.__esModule=!0},33:function(n,a,t){"use strict";t.d(a,"b",function(){return m}),t.d(a,"c",function(){return y}),t.d(a,"a",function(){return b}),t.d(a,"d",function(){return x});var i=t(29),r=t.n(i),p=t(8),c=t(17),d=function(u){return c.f.includes(u)?u.substring(0,u.lastIndexOf("-")):u===c.j?"neutral":[c.d,c.g].includes(u)||!c.k.includes(u)?"primary":u},m=function(u){var f=u.theme;return`
  ...
  `)},y=function(u){var f=u.theme,g=u.variant;return[].concat(r()(c.f),[c.g]).includes(g)?`
    ...
    `):`
    border: 1px solid `.concat(f.colors["".concat(d(g),"500")],`;
    background: `).concat(f.colors["".concat(d(g),"500")],`;
  `)},b=function(u){var f=u.theme,g=u.variant;return[].concat(r()(c.f),[c.g]).includes(g)?`
      background-color: `.concat(f.colors.neutral0,`;
      border: 1px solid `).concat(f.colors["".concat(d(g),"600")],`;
      `).concat(p.Typography,` {
        color: `).concat(f.colors["".concat(d(g),"600")],`;
      }
      svg {
        > g, path {
          fill: `).concat(f.colors["".concat(d(g),"600")],`;
        }
      }
    `):g===c.j?`
    ...
    `):`
    border: 1px solid `.concat(f.colors["".concat(d(g),"600")],`;
    background: `).concat(f.colors["".concat(d(g),"600")],`;
  `)},x=function(u){var f=u.theme,g=u.variant;switch(g){case c.c:case c.i:case c.g:return`
          border: 1px solid `.concat(f.colors["".concat(d(g),"200")],`;
          background: `).concat(f.colors["".concat(d(g),"100")],`;
          `).concat(p.Typography,` {
            color: `).concat(f.colors["".concat(d(g),"700")],`;
          }
          svg {
            > g, path {
              fill: `).concat(f.colors["".concat(d(g),"700")],`;
            }
          }
        `);case c.j:return`
          border: 1px solid `.concat(f.colors.neutral200,`;
      ...
      `);case c.h:case c.b:return`
        ...
        `)}}},37:function(n,a){n.exports=M},38:function(n,a,t){"use strict";t.r(a),t.d(a,"BaseButtonWrapper",function(){return e}),t.d(a,"BaseButton",function(){return o});var i,r=t(5),p=t.n(r),c=t(4),d=t.n(c),m=t(3),y=t.n(m),b=t(1),x=t.n(b),u=t(0),f=t.n(u),g=t(2),T=t.n(g),P=t(16),j=["disabled","children"],e=T.a.button(i||(i=y()([`
  display: flex;
  cursor: pointer;
  padding: `,`;
  border-radius: `,`;
...
`])),function(e){var o=e.theme,l=e.fontWeight;return o.fontWeights[l]},function(e){var o=e.theme,l=e.fontSize;return o.fontSizes[l]},function(e){var o=e.theme,l=e.lineHeight;return o.lineHeights[l]},function(e){var o=e.theme,l=e.textColor;return o.colors[l||"neutral800"]},function(e){return e.textTransform},function(e){return e.ellipsis&&`
  ...
  `},function(e){var o=e.variant,l=e.theme;switch(o){case"alpha":return`
      ...
      `);default:return`
        font-size: `.concat(l.fontSizes[2],`;
      `)}});j.defaultProps=g,j.propTypes=T}})})},26163:function(R,F,h){(function(s,I){R.exports=I(h(67294))})(this,function(s){return function(I){var M={};function n(a){if(M[a])return M[a].exports;var t=M[a]={i:a,l:!1,exports:{}};return I[a].call(t.exports,t,t.exports,n),t.l=!0,t.exports}return n.m=I,n.c=M,n.d=function(a,t,i){n.o(a,t)||Object.defineProperty(a,t,{enumerable:!0,get:i})},n.r=function(a){typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(a,"__esModule",{value:!0})},n.t=function(a,t){if(1&t&&(a=n(a)),8&t||4&t&&typeof a=="object"&&a&&a.__esModule)return a;var i=Object.create(null);if(n.r(i),Object.defineProperty(i,"default",{enumerable:!0,value:a}),2&t&&typeof a!="string")for(var r in a)n.d(i,r,function(p){return a[p]}.bind(null,r));return i},n.n=function(a){var t=a&&a.__esModule?function(){return a.default}:function(){return a};return n.d(t,"a",t),t},n.o=function(a,t){return Object.prototype.hasOwnProperty.call(a,t)},n.p="",n(n.s=97)}({0:function(I,M){I.exports=s},97:function(I,M,n){"use strict";n.r(M);var a=n(0);function t(){return(t=Object.assign||function(i){for(var r=1;r<arguments.length;r++){var p=arguments[r];for(var c in p)Object.prototype.hasOwnProperty.call(p,c)&&(i[c]=p[c])}return i}).apply(this,arguments)}M.default=function(i){return a.createElement("svg",t({width:"1em",height:"1em",viewBox:"0 0 32 32",fill:"none",xmlns:"http://www.w3.org/2000/svg"},i),a.createElement("path",{d:"M0 4a4 4 0 014-4h24a4 4 0 014 4v24a4 4 0 01-4 4H4a4 4 0 01-4-4V4z",fill:"#4945FF"}),a.createElement("path",{d:"M15.733 8c.343 0 .678.108.963.31.285.202.507.49.639.826.13.337.165.707.098 1.064a1.879 1.879 0 01-.474.942 1.705 1.705 0 01-.887.504 1.64 1.64 0 01-1.002-.105 1.76 1.76 0 01-.778-.678A1.924 1.924 0 0114 9.841a1.9 1.9 0 01.508-1.302c.325-.345.766-.539 1.225-.539zM20 24h-8v-2.265h2.933v-6.23H12.8v-2.266h4.267v8.495H20V24z",fill:"#fff"}))}}})})},28923:(R,F,h)=>{"use strict";h.r(F),h.d(F,{default:()=>Z});var s=h(67294),I=h(49656),M=h(68547),n=h(274),a=h.n(n),t=h(5493),i=h(97132),r=h(76835),p=(E,O,S)=>new Promise((Q,L)=>{var D=w=>{try{z(S.next(w))}catch(C){L(C)}},G=w=>{try{z(S.throw(w))}catch(C){L(C)}},z=w=>w.done?Q(w.value):Promise.resolve(w.value).then(D,G);z((S=S.apply(E,O)).next())});const c=()=>p(void 0,null,function*(){try{return yield(0,M.request)(`/${a()}/component`,{method:"GET"})}catch(E){return null}}),d=()=>p(void 0,null,function*(){try{return yield(0,M.request)(`/${a()}/content-types`,{method:"GET"})}catch(E){return null}}),m=()=>p(void 0,null,function*(){try{return(yield(0,M.request)(`/${a()}/component`,{method:"POST"},!0)).json()}catch(E){return null}});var y=h(67826),b=h(60985),x=h(49425),u=h(62791),f=h(41798),g=h(80768),T=h.n(g),P=h(84734),j=h.n(P),e=h(10156),o=h(11402),l=h(96486),B=h.n(l);const N=({contentTypes:E})=>{const{formatMessage:O}=(0,i.useIntl)();return s.createElement(s.Fragment,null,s.createElement(t.Box,{padding:8},s.createElement(o.TabGroup,{label:"label",id:"tabs"},s.createElement(o.Tabs,null,s.createElement(o.Tab,null,s.createElement(x.Typography,{variant:"omega"},O({id:(0,r.O)("SEOPage.tab.collection-type-title"),defaultMessage:"Collection Types"}))),s.createElement(o.Tab,null,s.createElement(x.Typography,{variant:"omega"},O({id:(0,r.O)("SEOPage.tab.single-type-title"),defaultMessage:"Single Types"})))),s.createElement(o.TabPanels,null,s.createElement(o.TabPanel,null,s.createElement(f.Table,{colCount:2,rowCount:E.collectionTypes.length},s.createElement(f.Thead,null,s.createElement(f.Tr,null,s.createElement(f.Th,null,s.createElement(x.Typography,{variant:"sigma"},O({id:(0,r.O)("SEOPage.tab-panel.column-name"),defaultMessage:"Name"}))))),s.createElement(f.Tbody,null,E&&E.collectionTypes&&!B().isEmpty(E.collectionTypes)?E.collectionTypes.map(S=>s.createElement(f.Tr,{key:S.uid},s.createElement(f.Td,null,s.createElement(x.Typography,{textColor:"neutral800"},S.globalId)),s.createElement(f.Td,null,s.createElement(y.Flex,{justifyContent:"right",alignItems:"right"},S.seo?s.createElement(b.LinkButton,{disabled:!0,startIcon:s.createElement(j(),null)},O({id:(0,r.O)("SEOPage.info.added"),defaultMessage:"Added"})):s.createElement(b.LinkButton,{startIcon:s.createElement(T(),null),variant:"secondary",to:`/plugins/content-type-builder/content-types/${S.uid}`},O({id:(0,r.O)("SEOPage.info.add"),defaultMessage:"Add component"})))))):s.createElement(t.Box,{padding:8,background:"neutral0"},s.createElement(u.EmptyStateLayout,{icon:s.createElement(e.w,null),content:O({id:(0,r.O)("SEOPage.info.no-collection-types"),defaultMessage:"You don't have any collection-types yet..."}),action:s.createElement(b.LinkButton,{to:"/plugins/content-type-builder",variant:"secondary",startIcon:s.createElement(T(),null)},O({id:(0,r.O)("SEOPage.info.create-collection-type"),defaultMessage:"Create your first collection-type"}))}))))),s.createElement(o.TabPanel,null,s.createElement(f.Table,{colCount:2,rowCount:E.singleTypes.length},s.createElement(f.Thead,null,s.createElement(f.Tr,null,s.createElement(f.Th,null,s.createElement(x.Typography,{variant:"sigma"},O({id:(0,r.O)("SEOPage.tab-panel.column-name"),defaultMessage:"Name"}))))),s.createElement(f.Tbody,null,E&&E.singleTypes&&!B().isEmpty(E.singleTypes)?E.singleTypes.map(S=>s.createElement(f.Tr,{key:S.uid},s.createElement(f.Td,null,s.createElement(x.Typography,{textColor:"neutral800"},S.globalId)),s.createElement(f.Td,null,s.createElement(y.Flex,{justifyContent:"right",alignItems:"right"},S.seo?s.createElement(b.LinkButton,{disabled:!0,startIcon:s.createElement(j(),null)},O({id:(0,r.O)("SEOPage.info.added"),defaultMessage:"Added"})):s.createElement(b.LinkButton,{startIcon:s.createElement(T(),null),variant:"secondary",to:`/plugins/content-type-builder/content-types/${S.uid}`},O({id:(0,r.O)("SEOPage.info.add"),defaultMessage:"Add component"})))))):s.createElement(t.Box,{padding:8,background:"neutral0"},s.createElement(u.EmptyStateLayout,{icon:s.createElement(e.w,null),content:O({id:(0,r.O)("SEOPage.info.no-single-types"),defaultMessage:"You don't have any single-types yet..."}),action:s.createElement(b.LinkButton,{to:"/plugins/content-type-builder",variant:"secondary",startIcon:s.createElement(T(),null)},O({id:(0,r.O)("SEOPage.info.create-single-type"),defaultMessage:"Create your first single-type"}))})))))))))};var k=h(78862),v=h(19352),H=h.n(v);const V=E=>{const{formatMessage:O}=(0,i.useIntl)();return s.createElement(t.Box,{background:"neutral100"},s.createElement(k.BaseHeaderLayout,{secondaryAction:E?null:s.createElement(b.LinkButton,{variant:"tertiary",to:"/plugins/content-type-builder/component-categories/shared/shared.seo",startIcon:s.createElement(H(),null)},O({id:(0,r.O)("SEOPage.header.button.edit-component"),defaultMessage:"Edit SEO component"})),title:O({id:(0,r.O)("SEOPage.header.title"),defaultMessage:"SEO"}),subtitle:O({id:(0,r.O)("SEOPage.header.subtitle"),defaultMessage:"Optimize your content to be SEO friendly"}),as:"h2"}))};var X=h(26163),W=h.n(X),Y=h(25108),J=(E,O,S)=>new Promise((Q,L)=>{var D=w=>{try{z(S.next(w))}catch(C){L(C)}},G=w=>{try{z(S.throw(w))}catch(C){L(C)}},z=w=>w.done?Q(w.value):Promise.resolve(w.value).then(D,G);z((S=S.apply(E,O)).next())});const $=()=>{const{formatMessage:E}=(0,i.useIntl)(),{lockAppWithAutoreload:O,unlockAppWithAutoreload:S}=(0,M.useAutoReloadOverlayBlocker)(),[Q,L]=(0,s.useState)(!0),[D,G]=(0,s.useState)(!1),z=(0,s.useRef)({}),w=(0,s.useRef)({});return(0,s.useEffect)(()=>J(void 0,null,function*(){if(z.current=yield c(),w.current=yield d(),!z.current)try{O(),yield m()}catch(C){Y.log(C)}finally{S(),G(!0)}L(!1)}),[D]),Q?s.createElement(M.LoadingIndicatorPage,null):s.createElement(s.Fragment,null,s.createElement(V,{seoComponent:z.current}),s.createElement(t.Box,{paddingLeft:8,paddingRigth:8},s.createElement(M.ContentBox,{title:E({id:"Information",defaultMessage:"Information"}),subtitle:E({id:(0,r.O)("SEOPage.info.information"),defaultMessage:"When adding your SEO component, make sure to name it 'seo' and to include it in the root of your Content-Type."}),icon:s.createElement(W(),null),iconBackground:"primary100"})),s.createElement(N,{contentTypes:w.current}))},K=(0,s.memo)($),Z=()=>s.createElement("div",null,s.createElement(I.Switch,null,s.createElement(I.Route,{path:`/plugins/${a()}`,component:K,exact:!0}),s.createElement(I.Route,{component:M.NotFound})))}}]);

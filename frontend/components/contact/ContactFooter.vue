    ...
    <div class="contact-footer">
        ...
        <div class="contact-footer__container">
            <div class='contact-footer__form'>
                <OnqorInput class="input-spacing" inputPlaceHolder="Name" />
                <OnqorInput class="input-spacing" inputPlaceHolder="Email" />
                <OnqorInput class="input-spacing" inputPlaceHolder="Contact Number" />
